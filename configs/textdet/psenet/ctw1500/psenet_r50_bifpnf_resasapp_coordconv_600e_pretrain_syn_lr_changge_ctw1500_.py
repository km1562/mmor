...
load_from = 'result/syntext/psenet_r50_bifpnf_resasapp_7_coordconv_4e_syntext_ten_log_adam_2_3_sucess_run/latest.pth'
...
# learning policy
lr_config = dict(policy='step', step=[200, 400, 500])
total_epochs = 600
